  ...
  return (
    <div className="bg-black min-h-screen flex items-center justify-center pt-20">
      <div className="container-luxury text-center">
        ...
        >
          <h1 className="font-cursive text-5xl md:text-7xl text-white mb-6">Program Brochure</h1>
          ...
          <p className="text-gray-500 mt-6 text-sm uppercase tracking-[0.3em]">
            The artistic journey and repertoire details will be available shortly.
          </p>
        </motion.div>
      </div>
    </div>
